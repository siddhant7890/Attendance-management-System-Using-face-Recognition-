...
titl = tk.Label(window, bg="Light blue", relief=RIDGE, bd=10, font=("arial", 35))
titl.pack(fill=X)
l1 = tk.Label(window, image=logo1, bg="black",)
l1.place(x=325, y=10)

titl = tk.Label(
    window, text="K J Somaiya College of Engineering!!", bg="Light blue", fg="black", font=("arial", 27),
)
...
def TakeImageUI():
    ...
    # image and title
    titl = tk.Label(
        ImageUI, text="Register Your Face", bg="black", fg="Light blue", font=("arial", 30),
    )
